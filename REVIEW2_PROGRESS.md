...
| W4 | `webapp` components + hooks + pages — **not previously read** | ~5,400 | **done** | 7 |
| W5 | `webapp` config: `next.config.ts`, `vercel.json`, `tsconfig.json`, `package.json`, `tailwind.config.ts` | ~200 | **done** | 2 |
